        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    MechanicName = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    Notes = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 4, 25, 19, 10, 7, 689, DateTimeKind.Utc).AddTicks(4005), "Full system control — manage staff, vendors, inventory, and generate financial reports", "Admin" },
                    { 2, new DateTime(2026, 4, 25, 19, 10, 7, 689, DateTimeKind.Utc).AddTicks(5137), "Handle customer registrations, part sales, invoicing, and customer reports", "Staff" },
                    { 3, new DateTime(2026, 4, 25, 19, 10, 7, 689, DateTimeKind.Utc).AddTicks(5140), "Self-register, book appointments, track history, and receive AI alerts", "Customer" }
                });
